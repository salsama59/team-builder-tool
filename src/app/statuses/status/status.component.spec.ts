...
describe('StatusComponent', () => {
	...
	it('should render the status form with values from current status', () => {
		...
		expect(
			compiled.query(By.css('#battingEfficiencyFormInput')).nativeElement.value
	...
	it('should render the status form in disabled state', () => {
		...
		expect(
			compiled.query(By.css('#catchEfficiencyFormInput')).nativeElement.disabled
		).toBeTruthy();
		expect(
			compiled.query(By.css('#pitchEfficiencyFormInput')).nativeElement.disabled
		).toBeTruthy();
		expect(
			compiled.query(By.css('#passEfficiencyFormInput')).nativeElement.disabled
		).toBeTruthy();
		expect(
		...
		expect(
			compiled.query(By.css('#pitchingEffectFormInput')).nativeElement.disabled
		).toBeTruthy();
	});
});
