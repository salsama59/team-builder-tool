...
export class StatusesComponent implements OnInit {
   ...
   */
  constructor(private statusService: StatusService, private router: Router, private activatedRoute: ActivatedRoute) { }
  ...
  onViewStatusElement(statusId: number): void {
    this.router.navigate([statusId], { relativeTo: this.activatedRoute });
  }
