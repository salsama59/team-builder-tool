...
describe('PlayerComponent', () => {
	...
	it('should render the player form with values from current player', () => {
		...
		expect(
			compiled.query(By.css('#playerNameFormInput')).nativeElement.value
		).toContain(playerComponent.currentPlayer?.playerName);
		expect(
	...
	it('should render the player form in disabled state', () => {
		...
		expect(
			compiled.query(By.css('#playerStatusIdFormInput')).nativeElement.disabled
		).toBeTruthy();
		expect(
			compiled.query(By.css('#playerAbilityIdFormInput')).nativeElement.disabled
		).toBeTruthy();
		expect(
			compiled.query(By.css('#playerNameFormInput')).nativeElement.disabled
		).toBeTruthy();
		expect(
			compiled.query(By.css('#playerFieldPositionFormInput')).nativeElement
				.disabled
