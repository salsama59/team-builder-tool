...
describe('StatusService', () => {
  ...
  it('should return a status element', () => {
    expect(statusService.getStatusById(0)).toEqual(new Status(0, 0, 10, 27, 60.5, 70.5, 45, 5, 50, 78, 15));
  });

  it('should add a new status element', () => {
    const newAddedStatus: Status = new Status(1, 1, 10, 30, 6.5, 70.5, 46, 10, 50, 80, 15);
  ...
  it('should delete a status element', () => {
    ...
    expect(statusService.getStatuses()).not.toContain(new Status(0, 0, 10, 27, 60.5, 70.5, 45, 5, 50, 78, 15));
  });
});
