...
export class Player {
     ...
     */
    constructor(public playerId: number, public playerTeamId: number, public playerStatusId: number, public playerAbilityId: number, public playerName: string, public playerFieldPosition: PlayerFieldPositionEnum, public defaultPlayerFieldPosition: PlayerFieldPositionEnum) { }
}